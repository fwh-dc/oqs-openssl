...
=head3 Removal of EC_METHOD_get_field_type()

EC_METHOD_get_field_type() was deprecated in OpenSSL 3.0 and removed in 4.0.
Applications should use EC_GROUP_get_field_type() as a replacement (see L<EC_GROUP_copy(3)>).

=head3 Removal of EC_GROUP_clear_free()

EC_GROUP_clear_free() was deprecated in OpenSSL 3.0. Migrating applications should use
EC_GROUP_free() instead.

=head3 Removal of EC_GROUP_new()

EC_GROUP_new() was deprecated in OpenSSL 3.0 migrating applications should
use one of the other EC_GROUP_new_* constructors instead.
