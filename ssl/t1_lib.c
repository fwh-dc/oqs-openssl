                                             ...
                                             SSL_SESSION **ret)
{
    ...
    *ret = NULL;
     ...
     * resumption.
     */
    if ((!SSL_CONNECTION_IS_DTLS(s) && s->version <= SSL3_VERSION) || !tls_use_ticket(s))
                                     ...
                                     size_t sesslen, SSL_SESSION **psess)
{
    ...
    if (!(SSL_CONNECTION_IS_TLS13(s) || SSL_CONNECTION_IS_DTLS13(s)) && s->ext.session_secret_cb) {
        /*
    ...
    if (s->ext.session_secret_cb == NULL || (SSL_CONNECTION_IS_TLS13(s) || SSL_CONNECTION_IS_DTLS13(s))) {
        switch (ret) {
